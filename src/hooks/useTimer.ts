...
import type { TimerState, TimerAction, WorkoutConfig, Phase } from "../types/timer";
import { createDefaultWorkout } from "../types/timer";
  ...
  switch (action.type) {
    ...
    case "TICK": {
      ...
      if (state.phase === "workout") {
        ...
        // No rest — advance to next round/section
...
export function useTimer(initialConfig?: WorkoutConfig) {
  ...
  // Track phase and position changes for audio cues
